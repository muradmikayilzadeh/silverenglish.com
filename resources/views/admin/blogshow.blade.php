                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">{{$blog->created_at}} tarixində dərc edilib.</p>
                            </div>
                            <div class="content table-responsive table-full-width">

                                <a href="{{url('/admin/blogs')}}" class="btn btn-success">Məqalələr</a>

                                <form action="{{url('/admin/blogstatus')}}" style="display: inline-block;" method="post">
                                    
                                    {{csrf_field()}}
                                    <label for="status">
                                       <a  class="btn btn-danger">
                                            Məqaləni @if($blog->active=='0') aktiv @else deaktiv @endif et
                                       </a>
                                    </label>
